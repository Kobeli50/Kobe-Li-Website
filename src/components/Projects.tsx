...
const Projects = () => {
  const projects = [
    {
      title: "TaskFlow",
      description: "A modern task management application built with React and TypeScript. Features real-time collaboration and beautiful UI.",
    ...
    {
      title: "Portfolio CMS",
      description: "A content management system specifically designed for portfolio websites with drag-and-drop functionality.",
    ...
    <section id="projects" className="py-20 bg-gradient-subtle">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-12 text-center">Projects I've Worked On</h2>
